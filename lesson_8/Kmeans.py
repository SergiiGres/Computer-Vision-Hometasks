#
# k-means
# K-means is an unsupervised clustering algorithm. It is an iterative optimization process that calculates the
# centroids (cluster centers) that minimize a certain metric (usually the Euclidean distance). In this notebook,
# we are going to implement a simple version of k-means to quantize a grayscale image.
